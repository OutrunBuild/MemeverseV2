...
- 辅助池 `POL/uAsset`、`PT/uAsset`、`PT/POL` fee
  ...
  - 辅助池 fee 分流的 token 级处理与操作语义 home 在 [docs/spec/polend/settlement-and-fees.md §15](../polend/settlement-and-fees.md)，PT fee 的预兑付 / settle 后 redeem / pending 规则 home 在 [docs/spec/polend/settlement-and-fees.md §20](../polend/settlement-and-fees.md)；分账口径与 full-precision `mulDiv` 约束见 [docs/spec/verse/accounting.md](../verse/accounting.md) §5.2
- `memecoin` yield
  - 进入 yield 路径
