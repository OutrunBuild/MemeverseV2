# POLend Settlement & Fees（§15-18 + §20 + §22-27）

> 本文件由 polend.md 拆分而来，集中承载 POLend 的 fee 归集/领取、结算编排、收益分发、权限配置与 Target ABI。
> §18 Locked -> Unlocked 编排的唯一权威在本文件；core.md §4.1 指向此处。
