...
/**
 * @title Governance Cycle Incentivizer V2 (upgrade-target shell)
 * @notice Bare upgrade-target shell used by the UUPS upgrade test. Does NOT inherit the incentivizer.
 ...
 */
contract GovernanceCycleIncentivizerUpgradeableV2 is UUPSUpgradeable {
