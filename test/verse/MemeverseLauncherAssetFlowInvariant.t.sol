...
contract MemeverseLauncherRemoteFeeInvariantTest is StdInvariant, Test, MemeverseLauncherTestHelper {
    ...
    function setUp() external {
        ...
        setMemeverseForTest(
            launcherProxy,
            VERSE_ID,
            address(remoteUAsset),
            address(remoteMemecoin),
            address(liquidProof),
            address(0xD00D),
            address(0xCAFE),
            address(0),
...
contract MockPOLendForFeeSplit is POLendInvariantStub {
...
contract MockPOLSplitterForFeeSplit is POLSplitterInvariantStub {
